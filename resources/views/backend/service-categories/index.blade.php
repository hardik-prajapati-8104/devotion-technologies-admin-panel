...
@section('page-header')
    ...
    <div class="d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="subtitle">Group your services for easier browsing on the website.</p>
        </div>
        @can('services.create')
    ...
    <div class="card-body">
        @if ($categories->isEmpty())
            <x-admin.empty-state
                ...
                description="Create your first service category to start organizing services."
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                @can('services.edit')
                                    <li><a class="dropdown-item" href="{{ route('admin.service-categories.edit', $category->id) }}"><i class="bi bi-pencil me-2"></i>Edit</a></li>
                                @endcan
                                @can('services.delete')
                                    <li>
